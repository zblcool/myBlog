...
#### How to refer a variable in another diferent namespace
**scope** 
...
### example 1 Defind a really simple C++ class
...
```
### example 2 instantiate an object of a really simple class
...
### example 3 invoke member function of an object.
...
### example 4 correctly use an initianlisation list in a constructor
...
### example 5 use a DESTRUCTOR properly to clean up member varaiables 
...
## chapter 4 mutiple files system
